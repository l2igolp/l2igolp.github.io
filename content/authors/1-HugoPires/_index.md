...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:hugo.pires@tecnico.ulisboa.pt'
#  - icon: twitter
#    icon_pack: fab
...
#    link: http://web.tecnico.ulisboa.pt/goncalo.figueira/
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=Sb1clZcAAAAJ&hl=en&oi=sra
  - icon: researchgate
    icon_pack: ai
    link: https://www.researchgate.net/profile/Hugo-Pires-3
  - icon: orcid
    icon_pack: fab
    link: https://orcid.org/0000-0003-1521-6392
  - icon: linkedin
    icon_pack: fab
